...
public class MovableEntity extends TexturedEntity implements Movable
{

	public MovableEntity(World world, MapObject mapObject, BodyType bodyType, String textureAtlasPath,
